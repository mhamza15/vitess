...
func (x TableCopyPhase) Enum() *TableCopyPhase {
	p := new(TableCopyPhase)
	*p = x
	return p
}

func (x TableCopyPhase) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (TableCopyPhase) Descriptor() protoreflect.EnumDescriptor {
	return file_vtctldata_proto_enumTypes[3].Descriptor()
}

func (TableCopyPhase) Type() protoreflect.EnumType {
	return &file_vtctldata_proto_enumTypes[3]
}

func (x TableCopyPhase) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use TableCopyPhase.Descriptor instead.
func (TableCopyPhase) EnumDescriptor() ([]byte, []int) {
...
func (SchemaMigration_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_vtctldata_proto_enumTypes[5].Descriptor()
}

func (SchemaMigration_Status) Type() protoreflect.EnumType {
	return &file_vtctldata_proto_enumTypes[5]
}
...
type BackupRequest struct {
	...
	// Optional queries to run on the mysqld instance prior to the backup and fields
	// to control the related behavior.
	InitSql       *tabletmanagerdata.BackupRequest_InitSQL `protobuf:"bytes,8,opt,name=init_sql,json=initSql,proto3" json:"init_sql,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *BackupRequest) GetInitSql() *tabletmanagerdata.BackupRequest_InitSQL {
	if x != nil {
		return x.InitSql
	}
	return nil
...
func (x *BackupShardRequest) GetInitSql() *tabletmanagerdata.BackupRequest_InitSQL {
	if x != nil {
		return x.InitSql
	}
	return nil
...
type WorkflowStatusResponse_TableCopyState struct {
	...
	Phase           TableCopyPhase         `protobuf:"varint,7,opt,name=phase,proto3,enum=vtctldata.TableCopyPhase" json:"phase,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *WorkflowStatusResponse_TableCopyState) GetPhase() TableCopyPhase {
	if x != nil {
		return x.Phase
	}
...
const file_vtctldata_proto_rawDesc = "" +
	...
	"\tParamList\x12\x16\n" +
	"\x06params\x18\x01 \x03(\tR\x06params\"\xae\x03\n" +
	"\rBackupRequest\x128\n" +
	...
	"\x16mysql_shutdown_timeout\x18\a \x01(\v2\x10.vttime.DurationR\x14mysqlShutdownTimeout\x12C\n" +
	"\binit_sql\x18\b \x01(\v2(.tabletmanagerdata.BackupRequest.InitSQLR\ainitSql\"|\n" +
	...
	"\x06shards\x18\x03 \x03(\tR\x06shards\"\x97\b\n" +
	...
	"\rtraffic_state\x18\x03 \x01(\tR\ftrafficState\x1a\x99\x02\n" +
	...
	"bytesTotal\x12)\n" +
	"\x10bytes_percentage\x18\x06 \x01(\x02R\x0fbytesPercentage\x12/\n" +
	"\x05phase\x18\a \x01(\x0e2\x19.vtctldata.TableCopyPhaseR\x05phase\x1a\xbc\x01\n" +
